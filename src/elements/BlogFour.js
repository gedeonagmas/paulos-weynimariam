        ...
        <div className="tmp-blog-area tmp-section-gap">
            ...
            <div className="row">
                ...
                <div className="header-top-inner">
                    ...
                    <Link to={'/Blog'} className="tmp-btn btn-primary">
                        View All Post
                    </Link>
                    </div>
                </div>
            ...
            <div className="row g-5 mt--10">
                <div
                className="col-lg-4 wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".1s">
                ...
                <div
                className="col-lg-4 wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".3s">
                <div className="single-blog blog-style-three">
                    <div className="blog-inner">
                    <div className="thumbnail">
                        <Link to={'/BlogDetails'}>
                ...
                <div
                className="col-lg-4 wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".5s">
                <div className="single-blog blog-style-three">
                    <div className="blog-inner">
                    <div className="thumbnail">
                        <Link to={'/BlogDetails'}>
