        ...
        <div className="tmp-counterup-area tmp-section-gapBottom">
          <div className="container">
            ...
            <div className="row g-5 mt--20 counter_animation">
              <div className="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".1s">
              ...
              <div
                className="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".3s">
                <div className="count-box counter-style-4 text-center">
                  <div>
                    <h3 className="title">
              ...
              <div
                className="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".5s">
                <div className="count-box counter-style-4 text-center">
                  <div>
                    <h3 className="title">
              ...
              <div
                className="col-lg-3 col-md-6 col-sm-6 col-12 counter__anim wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".7s">
                <div className="count-box counter-style-4 text-center">
                  <div>
                    <h3 className="title">
