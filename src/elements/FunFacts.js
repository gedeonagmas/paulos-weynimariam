    ...
    <div>
        ...
        <div className="tmp-counterup-area tmp-section-gapTop">
            ...
            <div className="row g-5 mt--20 counter_animation">
                ...
                <div
                className="col-lg-3 col-md-6 col-sm-6 col-12  wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".2s">
                <div className="count-box counter-style-4 text-center">
                    <div>
                        <CounterUp end={580}/>
                    </div>
                ...
                <div
                className="col-lg-3 col-md-6 col-sm-6 col-12  wow fadeInLeft" data-wow-duration=".8s" data-wow-delay=".4s"
                data-sal-delay={300}
                >
                <div className="count-box counter-style-4 text-center">
                    <div>
